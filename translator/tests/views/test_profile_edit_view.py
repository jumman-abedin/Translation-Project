...
from translator.tests.forms.helpers import reverse_with_next
...
class ProfileViewTest(TestCase):
    ...
    fixtures = [
        'translator/tests/fixtures/default_user.json',
        'translator/tests/fixtures/other_users.json'
    ]
    ...
    def test_succesful_profile_update(self):
        ...
        after_count = User.objects.count()
        self.assertEqual(after_count, before_count)
        response_url = reverse('translation')
        self.assertRedirects(response, response_url, status_code=302, target_status_code=200)
        self.assertTemplateUsed(response, 'translation.html')
